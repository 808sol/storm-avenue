        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6 tracking-wide" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              About Storm Avenue Roofing & Construction
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed">
              Your trusted roofing and construction professionals serving Mississippi with quality craftsmanship and exceptional service.
            </p>
          </div>
        </div>
      </section>
