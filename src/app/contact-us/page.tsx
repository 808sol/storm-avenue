...
export default function ContactUs() {
  return (
    <>
      ...
      <section className="relative overflow-hidden pt-16 pb-12" style={{ backgroundColor: '#1a1a1a' }}>
        {/* Background Pattern */}
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6 tracking-wide" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                Contact Storm Avenue Roofing & Construction
              </h1>
      ...
      <section className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ backgroundColor: '#1a1a1a' }}>
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute inset-0" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.4'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">Jackson • Madison • Brandon • Ridgeland • Flowood • Clinton • Pearl • Gluckstadt • Florence • Byram • Brookhaven • Vicksburg • McComb • Hattiesburg • Laurel</p>
                      </div>
                    </div>
