        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-primary-black mb-6">Request a Free Quote</h2>
              <ContactForm />
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        <p className="text-lg font-semibold">601-757-0740</p>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">Greater Jackson Metro Area, MS</p>
                      </div>
                    </div>
              ...
              <div className="bg-red-600 rounded-2xl p-8 text-white">
                ...
                >
                  ...
                  <span>Call Now: 601-757-0740</span>
                </a>
              </div>

              {/* Service Areas */}
              <div className="bg-gray-100 rounded-2xl p-8">
                <h3 className="text-xl font-bold text-primary-black mb-4">Service Areas</h3>
