...
export const metadata: Metadata = {
  metadataBase: new URL('https://stormavenue.com'),
  title: {
  ...
  alternates: {
    canonical: "https://stormavenue.com",
  },
  robots: {
    index: true,
    follow: true,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "image": "https://stormavenue.com/preview-logo.png",
              "logo": "https://stormavenue.com/sa-logo.png",
