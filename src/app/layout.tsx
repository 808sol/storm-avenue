...
export const metadata: Metadata = {
  ...
  title: {
    default: "Storm Avenue Roofing | Brandon, Madison, Ridgeland, Flowood, Clinton MS | 24/7 Service",
    template: "%s | Storm Avenue Roofing"
  },
  description: "Professional roofing contractor serving Brandon, Madison, Ridgeland, Flowood, Clinton, and all of Mississippi. 24/7 emergency storm damage repair, roof replacement, and insurance restoration. GAF Master Elite certified. Free estimates: (601) 748-4769.",
  ...
  openGraph: {
    ...
    title: "Storm Avenue Roofing | Brandon, Madison, Ridgeland, Flowood, Clinton MS",
    description: "Professional roofing contractor serving Brandon, Madison, Ridgeland, Flowood, Clinton, and Central Mississippi. 24/7 emergency response, storm damage repair, roof replacement. GAF Master Elite certified. Free estimates: (601) 748-4769.",
