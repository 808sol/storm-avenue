              ...
              <nav className="flex space-x-8">
                {navigationItems.map((item) => (
                  ...
                  >
                    {item.name}
                    {isActiveLink(item.href) ? (
                      <span className="absolute -bottom-1 left-0 right-0 h-[2px] bg-gray-900 rounded-full" />
                    ) : (
                      <span className="absolute -bottom-1 left-0 w-0 h-[2px] bg-gray-900 rounded-full transition-all duration-300 group-hover:w-full" />
                    )}
                  </Link>
                ))}
              </nav>
