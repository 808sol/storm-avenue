...
export function HeroSection() {
  ...
  useEffect(() => {
    if (videoError) {
      console.error('Video failed to load. Possible causes:');
      console.error('1. File too large for hosting service');
      console.error('2. CORS issues');
      console.error('3. Video format not supported');
      console.error('4. Network timeout');
    }
  }, [videoError])
          ...
          <div className="flex items-center gap-10">
            ...
            >
              <div className="relative px-14 py-5">
                ...
                {/* Button text */}
                <span className="relative z-10 text-white/80 group-hover:text-white/90 font-light text-[15px] tracking-[0.2em] flex items-center justify-center gap-3 uppercase transition-colors duration-500 lg:text-center xl:font-medium" style={{
                  fontFamily: 'Montserrat, sans-serif'
                }}>
                  <svg className="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
