  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`absolute left-1/2 transform -translate-x-1/2 z-20 transition-all duration-1500
        ...
        >
          <div className="relative">
            ...
            <div className="absolute inset-0 blur-2xl opacity-20 bg-white/50 rounded-full scale-125" />
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <div className={`transition-all duration-1200 delay-700 ${
              ...
              <p className="text-white/70 text-lg tracking-[0.15em] font-light">LICENSED • INSURED • TRUSTED
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-10">
            ...
            >
              <div className="relative px-14 py-5">
                ...
                {/* Button text */}
                <span className="relative z-10 text-white/80 group-hover:text-white/90 font-light text-[15px] tracking-[0.2em] flex items-center gap-3 uppercase transition-colors duration-500 lg:text-center" style={{
                  fontFamily: 'Montserrat, sans-serif'
                }}>
                  <svg className="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
