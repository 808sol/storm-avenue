    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ backgroundColor: '#1a1a1a' }}>
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">24/7 emergency roofing services across the Golden Triangle of Mississippi</p>
        </div>
