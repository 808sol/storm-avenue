            ...
            <div key={service.title} className="text-center hover-lift group" style={{ animationDelay: `${index * 0.2}s` }}>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  <a
                    href="/contact-us"
                    className="inline-block rounded-full bg-primary-black px-8 py-3 text-sm font-bold text-white hover:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-lg uppercase tracking-wide relative overflow-hidden group/btn"
                  >
